                        ...
                        value: function (e, t) {
                            ...
                            if (t.hasAttribute("data-image-url") && t.getAttribute("data-image-id") !== a.getAttribute("data-image-id")) {
                                ...
                                (o.className = "ProductItem__Image Image--fadeIn Image--lazyLoad"),
                                    ...
                                    const image_value = t.closest('.ProductItem__ColorSwatchItem');
                                    const image_value_final = image_value.querySelectorAll('.product-image img[alt="'+ input_value +'"]');
                                    const alternateImage = t.closest('.ProductItem__Wrapper');
                                    const alternateImage_final = alternateImage.querySelector('.ProductItem__Image--alternate');
                                    alternateImage_final.setAttribute("src", image_value_final[2].src);
                                    alternateImage_final.setAttribute("srcset", image_value_final[2].src);                                  
                            }
                        },
                    },
                ]),
                            ...
                            value: function () {
                                ...
                                (this.formPopovers = []),
                                    ...
                                    a["default"].nodeListToArray(this.element.querySelectorAll(".OptionSelector")).forEach(function (t) {
                                        var n = new i["default"](t, { preferredPosition: "bottom", onValueChanged: e._onOptionChanged.bind(e) });
                            ...
                            value: function (e, t, n) {
                                ...
                                (this.currentVariant = this._getCurrentVariantFromOptions()),
                                    ...
                                    this.currentVariant &&
                                        ...
                                        // custom js 24-01-2024
                                        $(n).closest('.ProductForm__Option').find('.ProductForm__SelectedValue').html(e);                                     
                                        setTimeout(function () {              
                                        if($(n).closest('.ProductForm__Option').hasClass('color')){
                                            if ($(window).width() > 1010) {                                              
                                                var get_value = $(n).closest('.ProductForm__Option').find('.VariantSelector__Choicee.is-selected').attr('data-value');
                                                var get_count = 0,var_loop;
                                                var product_image = $('.Product__Gallery .Product__SlideItem');                                                                            
                                                for (let i = 0; i < product_image.length; i++) {                                                                                                                                                             
                                                    product_image[i].classList.remove('hide-product');
                                                    const match_image = product_image[i].getAttribute('data-media-alt');                              
                                                    if (match_image == get_value) {
                                                        get_count++;
                                                        product_image[i].classList.add('show-product');
                                                        product_image[i].classList.remove('hide-product');
                                                    } else {
                                                        product_image[i].classList.add('hide-product');
                                                        product_image[i].classList.remove('show-product');
                                                    }                                                                                                   
                                                    
                                                }                              
                                                if (get_count == 0) {
                                                    $('.Product__Gallery .Product__SlideItem').addClass('show-product');
                                                    $('.Product__Gallery .Product__SlideItem').removeClass('hide-product');
                                                }
                                                $('.show-product:visible').last().addClass('Full_Width')
